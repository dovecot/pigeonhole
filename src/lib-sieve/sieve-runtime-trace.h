...
static inline bool
sieve_runtime_trace_active(const struct sieve_runtime_env *renv,
			   sieve_trace_level_t trace_level)
{
	return (renv->trace != NULL &&
		trace_level <= renv->trace->config.level);
}

static inline bool
sieve_runtime_trace_hasflag(const struct sieve_runtime_env *renv,
			    unsigned int flag)
{
	return (renv->trace != NULL &&
		(renv->trace->config.flags & flag) != 0);
}

/* Trace indent */

static inline void
sieve_runtime_trace_descend(const struct sieve_runtime_env *renv)
{
	if (renv->trace != NULL)
		renv->trace->indent++;
}
...
static inline void
sieve_runtime_trace_ascend(const struct sieve_runtime_env *renv)
{
	if (renv->trace != NULL)
		renv->trace->indent--;
}
...
static inline void
sieve_runtime_trace_toplevel(const struct sieve_runtime_env *renv)
{
	if (renv->trace != NULL)
		renv->trace->indent = 0;
}
...
static inline void
sieve_runtime_trace_error(const struct sieve_runtime_env *renv,
			  const char *fmt, ...) ATTR_FORMAT(2, 3);

static inline void
sieve_runtime_trace_operand_error(const struct sieve_runtime_env *renv,
				  const struct sieve_operand *oprnd,
...
void _sieve_runtime_trace(const struct sieve_runtime_env *renv,
			  const char *fmt, va_list args) ATTR_FORMAT(2, 0);

static inline void
sieve_runtime_trace(const struct sieve_runtime_env *renv,
		    sieve_trace_level_t trace_level, const char *fmt, ...)
		    ATTR_FORMAT(3, 4);
...
static inline void
sieve_runtime_trace_address(const struct sieve_runtime_env *renv,
			    sieve_trace_level_t trace_level,
...
static inline void ATTR_FORMAT(3, 4)
sieve_runtime_trace_here(const struct sieve_runtime_env *renv,
			 sieve_trace_level_t trace_level, const char *fmt, ...)
{
	va_list args;
...
static inline void
sieve_runtime_trace_begin(const struct sieve_runtime_env *renv)
{
	if (renv->trace != NULL)
...
static inline void
sieve_runtime_trace_end(const struct sieve_runtime_env *renv)
{
	if (renv->trace != NULL)
...
static inline void
sieve_runtime_trace_sep(const struct sieve_runtime_env *renv)
{
	if (renv->trace != NULL)
